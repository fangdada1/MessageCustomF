...
-(void)decodeWithData:(NSData *)data {
    ...
    if ([dict objectForKey:@"content"]) {
        ...
        self.fuyaExtra = dict[@"extra"];
    }else{
        self.content = [[NSString alloc]initWithData:[NSJSONSerialization dataWithJSONObject:dict options:kNilOptions error:nil] encoding:NSUTF8StringEncoding];
    }
